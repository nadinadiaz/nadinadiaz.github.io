...
const projects = [
  ...
  },
  {
    ...
    image: siniestralidad,
     deliverableUrl: "/docs/SiniestralidadLaboral.pdf",
    markdownUrl: "https://github.com/nadinadiaz/Data-Analytics-Siniestralidad-y-Salud-Mental-en-Argentina",
            ...
            >
              ...
              <div className="p-7 flex flex-col flex-1">
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {p.tags.map((tag) => (
                    <span key={tag} className="text-xs px-2.5 py-1 rounded-md bg-section-foreground/8 text-section-foreground/70 border border-primary/40">
                      {tag}
                    </span>
                  ))}
                </div>
